...
async function getList(sheet: string, spreadsheetId: string) {
...
exports.topcompanies = functions.region('asia-southeast2').https.onRequest(async (request: any, response: any) => {
